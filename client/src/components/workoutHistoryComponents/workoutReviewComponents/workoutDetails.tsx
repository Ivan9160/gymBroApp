            ...
            <Row className="justify-content-center">
                <Col md={10} lg={8}>
                    <Link to="/history" className="text-decoration-none mb-3 d-inline-block text-primary fw-bold">
                        <ArrowLeft className="me-2" /> Back to History
                    </Link>
                    ...
                    <Card className="shadow-lg border-0 rounded-4 overflow-hidden mb-4">
                        ...
                        <Card.Body className="bg-light py-3 border-bottom">
                            <Row className="text-center">
                                <Col>
                                    <div className="text-muted small uppercase fw-bold">Duration</div>
                                ...
                                <Col className="border-start border-end">
                                    <div className="text-muted small uppercase fw-bold">Exercises</div>
                                    <div className="fw-bold h5 mb-0"><Activity className="me-1 text-primary"/> {workout.sets.length}</div>
                                </Col>
                                <Col>
                                    <div className="text-muted small uppercase fw-bold">Total Volume</div>
                                    <div className="fw-bold h5 mb-0 text-success">{workout.sets.length} sets</div>
                                </Col>
                            </Row>
                        </Card.Body>

                        <Card.Body className="p-4">
                            <h4 className="mb-4 fw-bold">Exercises Summary</h4>
