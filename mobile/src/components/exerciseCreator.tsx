...
//         if (!trimmedName || !exerciseData.groupId || isSubmitting) {
//             return;
//         }
...
//     const selectedGroup = exerciseGroups.find(
//         (group: ExerciseGroup) => group.id === exerciseData.groupId
//     );

//     const isSubmitDisabled =
//         isSubmitting || !exerciseData.name.trim() || !exerciseData.groupId;
...
//                             {t("exercise_creator.title")}
//                         </Text>
//                         <Text style={styles.pageDescription}>
//                             {t("exercise_creator.description")}
//                         </Text>
//                     </View>
...
//                                     {t("exercise_creator.success_title")}
//                                 </Text>
...
//                             <View style={styles.alertContent}>
//                                 <Text style={styles.alertTitle}>
//                                     {t("exercise_creator.error_title")}
//                                 </Text>
//                                 <Text style={styles.alertText}>
//                                     {t("exercise_creator.error_message")}
//                                 </Text>
//                             </View>
...
//                                     onChangeText={(name) =>
//                                         setExerciseData((previous) => ({ ...previous, name }))
//                                     }
...
//                                         {selectedGroup
//                                             ? t(`database.exercise_groups.${selectedGroup.name}`, {
...
//                                             const isActive = group.id === exerciseData.groupId;
...
//                                 {exerciseGroups.length === 0 && (
//                                     <Text style={styles.formHelpWarning}>
...
//                                 <Switch
//                                     value={exerciseData.isBodyweight}
//                                     onValueChange={(isBodyweight) =>
//                                         setExerciseData((previous) => ({
//                                             ...previous,
//                                             isBodyweight,
//                                         }))
...
//                                         {t("exercise_creator.bodyweight")}
//                                     </Text>
//                                     <Text style={styles.checkboxHelp}>
//                                         {t("exercise_creator.bodyweight_help")}
//                                     </Text>
//                                 </View>
//                             </View>
...
//                                     style={[
//                                         styles.primaryCta,
//                                         isSubmitDisabled && styles.primaryCtaDisabled,
//                                     ]}
...
//                             {t("exercise_creator.tip_title")}
//                         </Text>
//                         <Text style={styles.tipText}>
//                             {t("exercise_creator.tip_text")}
//                         </Text>
//                     </View>
//                 </View>
//             </View>
